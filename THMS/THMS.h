 ...
 *************************************************************************************/
void thms_get_sensor_signal(int32_t * p_SensorSignal, int32_t * p_MeasurementSignal, uint32_t * p_rsqrt_indicator, uint32_t pulseLenght_inms, uint32_t fitStart_inms);
